...
######
 ...
 ###############################
  ...
  self.var7.set(1)
  GPIO.add_event_detect(11,GPIO.RISING,callback=self.Start,bouncetime=2000)# input from PLC
  self.valueAnalyse=0
 ...
 def Takepic(self):  ## take pic button
	  ...
	  if self.var3.get() == True:
		  src=cv2.imread("analysed.png")
		   #src=cv2.fastNlMeansDenoising(src,None,10,10,7)
	  ...
	  if self.varJudgement.get() == True : #and self.var3.get() == True:
		  ...
		  #if number_White2< 50 :
		  if Area1==1 and Area2==1 and Area3==1 and Area4==1:
			  ...
			  if self.varSaveOK.get()==1:
				  ...
				  cv2.imwrite("/home/pi/Desktop/Data/Image/{0:%Y%m%d-%H%M%S}.png" .format(datetime.now()),img_OKNG)
